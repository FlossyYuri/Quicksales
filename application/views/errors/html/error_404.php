		...
		<div class="container-xl">
			<div class="row">
				<div class="col-md-6 d-flex align-items-center">
					<div class="">
						<h3 style="font-size: 3rem; color: var(--main-color);font-weight: 600">Oops,<br> Voce está perdido!</h3>
						<p style="font-weight: 500" class="text-muted">Sentimos muito pelo inconveniente. <br> Você está tentando acessar uma pagina que, ou foi apagada ou nunca existiu.</p>
					</div>
				</div>
				<div class="col-md-6">
